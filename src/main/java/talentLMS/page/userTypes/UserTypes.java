package talentLMS.page.userTypes;
...
public class UserTypes extends BasePage {
    ...
    @FindBy(xpath = "(//a[text()='Skills']/preceding-sibling::span[contains(@class,'dynatree-expander')])[2]")
     ...
     * @return Объект UserTypes после выполнения операции.
     */
    public UserTypes delete(UserTypeEntity userType) {
